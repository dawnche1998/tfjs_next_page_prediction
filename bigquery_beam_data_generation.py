...
def is_duplicate_event(first_event: Dict[Text, Any], second_event: Dict[Text,Any]):
...
def run_beam_pipeline():
  ...
  with beam.Pipeline(
    ...
    _ = (
        p
        | 'ReadTable' >> beam.io.ReadFromBigQueßry(table=table_spec)
        ...
        | 'Write' >> beam.io.tfrecordio.WriteToTFRecord(
            ...
            file_name_suffix='./data/data.tfrecord.gz'))
